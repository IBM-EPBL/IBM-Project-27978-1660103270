...
COS_API_KEY_ID="UreGeQ93_trDU-QMqANIhrdL63qecZa_AZnvKBXrN0R_"
COS_INSTANCE_CRN="crn:v1:bluemix:public:iam-identity::a/997511a95f1745a8aecd66a0ea96adbc::serviceid:ServiceId-c0c72af5-4f96-47f6-ada3-99afe8c8010a"
...
@app.route('/')
def index():
    files = get_bucket_contents('plasmadonorapplication2001')
